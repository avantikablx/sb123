      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <a
            ...
            className="hidden md:flex items-center space-x-2 text-sm text-slate-300 hover:text-amber-400"
          >
          ...
          <a
            ...
            className="hidden sm:flex items-center space-x-2 text-sm text-slate-300 hover:text-amber-400"
          >
        ...
        <div className="lg:hidden absolute top-full left-0 right-0 bg-slate-900/95 backdrop-blur-lg border-t border-amber-500/20">
          <div className="px-6 py-6 space-y-4">
            <Link
              ...
              className="block w-full text-left text-slate-300 hover:text-amber-400 font-medium"
            >
              Home
            </Link>
            <Link
